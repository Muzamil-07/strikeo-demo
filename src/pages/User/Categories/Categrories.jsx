...
export default function TemporaryDrawer() {
    ...
    >
          ...
          >
            {subOpen1.map((category, index) => (
              <>
                <ListItemButton
                  sx={
                    subOpen2.length === category?.subcategories?.length &&
                    subOpen2[0]?.name === category?.subcategories[0]?.name
                      ? {
                          color: "orange",
                          background: "#F6F5F5",
                          p: 1,
                  ...
                  onMouseEnter={() => {
                    ...
                    if (
                      ...
                      setSubOpen2(category?.subcategories);
                    } else {
                      setSubOpen2([]);
                    }
                  }}
      ...
      <div style={{}}>
        <Box sx={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)" }}>
          {[...subOpen, ...subOpen1, ...subOpen2].map((o, i) => (
            <Box
              key={i + 1}
              sx={{
                p: 1,
  ...
  return (
    <div>
      {!open && <Button onClick={toggleDrawer(true)}>Open drawer</Button>}
      <Drawer
