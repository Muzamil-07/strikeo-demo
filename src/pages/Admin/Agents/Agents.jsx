      ...
      {isLoading || !paginatedData.agents ? (
        ...
        <>
          ...
          <div className="mb-5">
            ...
            <p className="text-sm mb-2">With the help of filters, you can easily find agents.</p>
            <div>
              <label
            ...
            <table className="md:w-full w-[900px] text-sm text-left text-black-500 dark:text-black-400">
              {paginatedData.agents?.length === 0 ? (
                    ...
                    {paginatedData.agents &&
                      paginatedData.agents.map(agent => (
                        ...
                        >
                          ...
                          <td className="px-6 py-4">{agent?.contact?.phone}</td>
                          <td className="pl-6 py-4">
                            <div className="flex gap-2">
                              {agent.id !== user?.details?.id &&
                                ...
                                user?.details?.role?.vendorPermissions.includes(
                                  ...
                                  <label className="relative inline-flex items-center cursor-pointer">
                                    <input
                                      type="checkbox"
                                      onChange={e => toggleEmployeeActivaition(agent)}
                              ...
                              <MdKeyboardArrowRight
                                ...
                                onClick={() => updateView("single-agent", agent)}
                              />
                            </div>
                          </td>
                        </tr>
               ...
               <TablePagination
                  ...
                  totalItems={paginatedData.totalAgents || 0}
        ...
        <div className="py-4">
          ...
          <AddForm userType="agent" getUsers={getAgents} updateView={updateView} />
        </div>
      ) : view === "single-agent" ? (
        <div className="py-4">
