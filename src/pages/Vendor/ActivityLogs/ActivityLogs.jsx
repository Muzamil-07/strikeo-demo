                      ...
                      paginatedData.activities.map((activity, i) => (
                        ...
                        >
                          ...
                          <td className="px-6 py-4">
                            {activity?.employeeName + " " + activity?.[activity.type]?.message}
                          </td>
                        </tr>
                      ))}
                  </tbody>
            ...
            >
              <span className="text-sm font-normal text-black-500 dark:text-black-400">
                ...
                <span className="font-semibold ">
                  ...
                  {Math.min(currentPage * itemsPerPage, paginatedData.totalActivities)}
                </span>{" "}
                of <span className="font-semibold ">{paginatedData.totalActivities}</span>
              </span>
              <Pagination
