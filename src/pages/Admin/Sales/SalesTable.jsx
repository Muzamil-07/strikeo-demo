...
export default function SalesTable({ paginatedData, getSales, currentPage, updateView, searchText, setSearchText }) {
	...
	return (
		<>
			<AddSaleDialog open={isAddOpen} setOpen={setIsAddOpen} />
			<div className="flex justify-between">
				<div className="mb-5">
					<h3 className="text-primary text-lg font-semibold">Search Filters</h3>
					<p className="text-sm mb-2">With the help of filters, you can easily find sales of a specific month.</p>
					<div>
						...
						<div className="relative">
							...
							<input
								...
								placeholder="Search sale by month..."
							/>
						</div>
					</div>
				</div>
								...
								{paginatedData.users &&
									paginatedData.users.map((user, i) => (
										<tr
											...
											<td className="px-6 py-4">12.11.2023</td>
