...
const English = () => {
  ...
  return (
    <div className="mt-8 pb-12 flex flex-col gap-4 text-justify overflow-y-auto max-h-[90%] pr-6 info-scroll text-secondary">
      <p>
        At StrikeO, we hope every product delights you. However, should you need
        to return an item, we make the process straightforward. Please first
        ...
        and write “Return – Order Number” so we can start your return right away
