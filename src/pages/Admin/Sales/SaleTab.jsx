          ...
          <div className='p-3 rounded flex flex-col gap-5'>
            ...
            {openIndex === 1 && (
              <>
                ...
                <div className='flex gap-4'>
                  ...
                  <span className=''>{format.formatMoney(456000)}</span>
                </div>
                <div className='flex align-middle gap-4'>
                  <span className='font-semibold'>Gross Margin</span>
                  <span className=''>
                    {format.formatMoney(grossMargin)}
                  </span>
                  <span>
                    as{' '}
                ...
                <div className='mb-5 flex justify-center bg-gray-100'>
                  <span className='font-medium text-sm  p-2'>
                    Total COGS = {format.formatMoney(calculateTotalCOGS())}
                  </span>
                </div>
                <div
                  className='bg-sky-200 py-2 text-center mt-3'
                ...
                <div className='mb-5 flex justify-center bg-gray-100'>
                  <span className='font-medium text-sm  p-2'>
                    Total OPEX = {format.formatMoney(calculateTotalOPEX())}
                  </span>
                </div>
                <div className='flex justify-between mt-3'>
                ...
                <div className='mb-5 flex justify-center bg-gray-100'>
                  <span className='font-medium text-sm p-2'>
                    Total Net Income = {format.formatMoney(totalNetIncome)}
                  </span>
                </div>
              </>
            )}
            ...
            {openIndex === 2 && (
              <>
                ...
                <div className='mb-5 flex justify-center bg-gray-100'>
                  <span className='font-medium text-sm  p-2'>
                    Total Current Assest = {format.formatMoney(calculateTotalCurrentAssets())}
                  </span>
                </div>
                <div
                  className='bg-sky-200 py-2 text-center mt-3'
                ...
                <div className='mb-5 flex justify-center bg-gray-100'>
                  <span className='font-medium text-sm  p-2'>
                    Total Net Fixed Assets = {format.formatMoney(calculateTotalFixedAsset())}
                  </span>
                </div>
                <div
                  className='bg-sky-200 py-2 text-center mt-3'
                ...
                <div className='mb-5 flex justify-center bg-gray-100'>
                  <span className='font-medium text-sm  p-2'>
                    Total Liabilities = {format.formatMoney(calculateTotalLiabilities())}
                  </span>
                </div>
                <div
                  className='bg-sky-200 py-2 text-center mt-3'
                ...
                <div className='flex justify-center bg-gray-100'>
                  <span className='font-medium text-sm  p-2'>
                    Total Liabilities + Shareholder = {format.formatMoney(totalLiabilititesShareholdersEquity)}
                  </span>
                </div>
                <div className='mb-5 flex justify-center bg-gray-100'>
                  <span className='font-medium text-sm  p-2'>
            ...
            {openIndex === 3 && (
              <>
                ...
                <div className='mb-5 flex justify-center bg-gray-100'>
                  <span className='font-medium text-sm  p-2'>
                    Total Operating Cash Flow = {format.formatMoney(3000)}  
                  </span>
                </div>
                <div
                  className='bg-sky-200 py-2 text-center mt-3'
                ...
                <div>
                  <span className='font-medium text-sm'>
                    Capex (Asset Purchases) {format.formatMoney(3000)} 
                  </span>
                </div>
                <div className='flex justify-center bg-gray-100'>
                  <span className='font-medium text-sm  p-2'>
                    Investing Cash Flow = {format.formatMoney(3000)}
                  </span>
                </div>
                <div className='mb-5 flex justify-center bg-gray-100'>
                  <span className='font-medium text-sm  p-2'>
                    Free Cash Flow = {format.formatMoney(3000)} 
                  </span>
                </div>
              </>
            )}
