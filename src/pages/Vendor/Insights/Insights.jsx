...
export default function VendorInsights() {
  ...
  return (
    <>
      <div
        className="w-full flex flex-col flex-grow bg-white"
              ...
              <div className="flex-grow px-5 md:px-16 py-4">
                ...
                <div className="mt-10">
                  <div className="flex gap-4">
                    <div
                      className="bg-gray-100 py-5 rounded-md"
                      style={{ width: "60%" }}
                    >
                ...
                <div className="flex gap-4 mt-5">
                  ...
                  <div
                    className="bg-gray-100 pl-8 py-5 pr-8 rounded-md"
                    style={{ width: "40%" }}
                  >
