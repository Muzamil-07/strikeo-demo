...
const VendorTabs = ({
  ...
  const selectedCountry = countries.find(
    (country) => country.name === selectedVendor?.company?.country
  );
  const states =
    cities[
  ...
  const handleCompanyChange = (key, value) => {
    if (key.includes(".")) {
      ...
      if (key === "country") {
        ...
        const citiesAvailable = Object.values(states || {}).flatMap(
          (stateCities) => stateCities.map((city) => city)
        );
  ...
  const validateCompany = () => {
    ...
    if (!vendor?.company?.zipCode?.trim()) {
  ...
  const updateCompany = async () => {
    ...
    try {
      ...
      const res = await http.put("company/" + vendor?.company?.id, {
        ...vendor.company,
        logo: vendor.company.file
          ? imgData[0]?.[vendor.company?.file?.name]
          : vendor.company.logo,
      });
  ...
  const createCompany = async () => {
    ...
    try {
      ...
      const res = await http.post("company", {
        ...company,
        vendor: selectedVendor?.id || vendor?.id,
              ...
              <div className="grid lg:grid-cols-4 grid-cols-2 gap-4">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <input
                    ...
                    value={
                      vendor?.dob
                        ? new Date(vendor.dob).toISOString().split("T")[0]
                        : ""
                    }
                    onChange={(e) =>
                      setVendor({ ...vendor, dob: e.target.value })
                    }
                    className="block px-4 py-2 text-sm text-primary border border-gray-300 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                  />
                  {vendorErrors.dob && (
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <input
                    ...
                    value={
                      mode === "view"
                        ? vendor?.contact?.secondaryPhone || "N/A"
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <input
                    ...
                    value={
                      mode === "view"
                        ? vendor?.emergencyContact?.name || "N/A"
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <input
                    ...
                    value={
                      mode === "view"
                        ? vendor?.emergencyContact?.phone || "N/A"
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <input
                    ...
                    disabled={mode === "view"}
                    value={
                      mode === "view" ? vendor?.alias || "N/A" : vendor?.alias
                    }
                    onChange={(e) =>
                      setVendor({ ...vendor, alias: e.target.value })
                    }
                    className="block px-4 py-2 text-sm text-primary border border-gray-300 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                  />
                </div>
                <div className="flex flex-col gap-2">
                  ...
                  <MyTooltip
                    title={
                      !vendor?.isVerified ? "This vendor is not verified!" : ""
                    }
                  >
                    <input
                      type="text"
                      ...
                      disabled={mode === "view" || !vendor?.isVerified}
                      value={vendor?.password}
                      onChange={(e) =>
                        setVendor({ ...vendor, password: e.target.value })
                      }
                      className="block px-4 py-2 text-sm text-primary border border-gray-300 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    />
                  </MyTooltip>
                ...
                <div className="flex-1 flex flex-col gap-7">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleCompanyChange("principalPOB", e.target.value)
                      }
                      className="block px-4 py-2 text-sm text-primary border border-gray-300 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    />
