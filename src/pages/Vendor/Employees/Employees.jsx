...
const Employees = () => {
  ...
  const toggleActivation = (employee) => {
    try {
      const res = http.put(
        "/company/employee/toggle-activation/" + employee?.id
      );

      toast.success(
        `Employee ${employee?.isActive ? "blocked" : "unblocked"} successfully.`
      );
                                ...
                                <td className="pl-6 py-4">
                                  <div className="flex gap-2">
                                    ...
                                    <MdKeyboardArrowRight
                                      ...
                                      onClick={() =>
                                        updateView("single-user", employee)
                                      }
                                    />
                                  </div>
                                </td>
