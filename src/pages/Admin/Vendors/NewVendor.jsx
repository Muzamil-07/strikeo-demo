...
const NewVendor = ({ getVendors, setView }) => {
    ...
    <div className="flex justify-between w-full h-full">
      {
        <div className="col-span-2 flex flex-col pt-[25vh] gap-4 px-5">
          <div className="flex justify-center items-center">
            <ol className="relative h-min text-gray-500 border-s border-gray-200 dark:border-gray-700 dark:text-gray-400">
              <li className={`mb-5 ms-6 ${step === 1 ? "text-blue-400" : ""}`}>
                ...
                <h3 className="font-medium leading-tight">Vendor Info</h3>
                <p className="text-sm">Vendor details here</p>
              </li>
              <li className={`ms-6 ${step === 2 ? "text-blue-400" : ""}`}>
                ...
                <p className="text-sm">Company details here</p>
              </li>
            </ol>
          </div>
          {step === 1 ? (
